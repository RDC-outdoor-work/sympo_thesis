...
\eauthor{Yuuki TAKAHASHI, Masaki FUJIWARA, Kazuki SHIRASU, Yusuke KIYOOKA, Kenta HARUYAMA, Hayato IGUCHI, Masato HIDAKA, Ryuichi UEDA and Yasuo HAYASHIBARA (CIT)}
...
\subsubsection{提案手法}
提案手法を\figref{fig:kirikae}に示す. 移動ロボットは, 2つの走行方法を持つ. この2つの走行方法は, emcl2[3]のalpha\footnote[2]{センサ更新後のパーティクルの周辺尤度}を指標として切り替える.
