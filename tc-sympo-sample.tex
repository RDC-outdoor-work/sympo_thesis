...
\begin{table}[h]
  \centering
    ...
    \begin{tabular}{|l||c|c|c|}  \hline
      ...
      Depth[mm] & 690 & 600 &  600\\ \hline
      Wide[mm] & 560 & 506.5 &  506.5\\ \hline
      Height[mm] & 770 & 957 &  957\\ \hline
...
\subsubsection{提案手法}
提案手法を\figref{fig:kirikae}に示す. 移動ロボットは, 2つの走行方法を持つ. この2つの走行方法は, emcl2[3]のalphaを指標として切り替える.
...
これらの処理を施した画像を用いて, \figref{fig:seg}の対応する箇所に応じた行動を生成する. 具体的には, \figref{fig:seg}のTurn leftの範囲に走行可能領域以外のラベルによるピクセル
